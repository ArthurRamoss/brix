...
const pt = {
  ...
  shell_wallet_tip:
    "endereço da sua wallet solana (criada pela Privy quando você logou). clique pra copiar.",
  shell_wallet_copied: "endereço copiado",
  ...
  reg_r_brix_fee: "fee brix",
  reg_r_investor_yield: "yield investidor",
  ...
  inv_tvl_delta_suffix: "nas últimas 24h",
  inv_chart_empty: "histórico aparece a partir do primeiro depósito",
  inv_chart_past: "histórico",
  inv_chart_today: "hoje",
  inv_chart_projected: "projetado",
  inv_chart_legend_realized: "realizado",
  inv_chart_legend_projected: "projetado",
  inv_chart_anchor_start: "início",
  inv_chart_stat_tvl_now: "tvl hoje",
  inv_chart_stat_projected_in: (d: number) => `projetado em ${d}d`,
  inv_chart_stat_events: "eventos",
  inv_chart_stat_projected: "entrada projetada",
  inv_chart_stat_active: "contratos ativos",
  inv_history_h: "histórico de operações",
  inv_history_empty: "nenhuma operação registrada ainda",
  inv_history_kind_deposit: "depósito",
  inv_history_kind_withdraw: "saque",
  inv_history_kind_fund: "antecipação liberada",
  inv_history_kind_repay: "repagamento recebido",
  inv_history_loading: "carregando histórico…",
  inv_history_see_all: "ver tudo",
  inv_history_page_h: "histórico de operações",
  inv_history_filter_all: "todas",
  inv_history_filter_deposit: "depósitos",
  inv_history_filter_withdraw: "saques",
  inv_history_filter_fund: "antecipações",
  inv_history_filter_repay: "repagamentos",
  inv_recent_events: "últimas operações",
  inv_history_th_when: "quando",
  inv_history_th_kind: "operação",
  inv_history_th_amount: "valor",
  inv_history_th_tx: "tx",
  inv_apr_30d: "apr 30d",
  ...
  reg_pre_brix_fee: "fee brix protocolo",
  reg_pre_investor_yield: "yield ao investidor",
  reg_months_help: "entre 3 e 12 meses · taxa cresce levemente com o prazo.",
  reg_apr_l: "taxa anual cobrada do proprietário",
  reg_apr_help: ((min: number, max: number) =>
    `entre ${min}% e ${max}% · brix retém 2% como spread, restante vai pro investidor`) as unknown as string,
  reg_apr_oor: ((min: number, max: number) =>
    `taxa fora do intervalo permitido (${min}% – ${max}%)`) as unknown as string,
...
const en = {
  ...
  shell_wallet_tip:
    "your solana wallet address (created by Privy when you signed in). click to copy.",
  shell_wallet_copied: "address copied",
  ...
  reg_r_brix_fee: "brix fee",
  reg_r_investor_yield: "investor yield",
  ...
  inv_tvl_l: "total value locked",
  inv_tvl_delta_suffix: "in last 24h",
  inv_chart_empty: "history appears once the first deposit lands",
  inv_chart_past: "history",
  inv_chart_today: "today",
  inv_chart_projected: "projected",
  inv_chart_legend_realized: "realized",
  inv_chart_legend_projected: "projected",
  inv_chart_anchor_start: "start",
  inv_chart_stat_tvl_now: "tvl now",
  inv_chart_stat_projected_in: (d: number) => `projected in ${d}d`,
  inv_chart_stat_events: "events",
  inv_chart_stat_projected: "projected inflow",
  inv_chart_stat_active: "active contracts",
  inv_history_h: "operation history",
  inv_history_empty: "no operations recorded yet",
  inv_history_kind_deposit: "deposit",
  inv_history_kind_withdraw: "withdraw",
  inv_history_kind_fund: "advance funded",
  inv_history_kind_repay: "repayment received",
  inv_history_loading: "loading history…",
  inv_history_see_all: "see all",
  inv_history_page_h: "operation history",
  inv_history_filter_all: "all",
  inv_history_filter_deposit: "deposits",
  inv_history_filter_withdraw: "withdraws",
  inv_history_filter_fund: "advances funded",
  inv_history_filter_repay: "repayments",
  inv_recent_events: "recent operations",
  inv_history_th_when: "when",
  inv_history_th_kind: "operation",
  inv_history_th_amount: "amount",
  inv_history_th_tx: "tx",
  inv_apr_30d: "apr 30d",
  ...
  reg_pre_brix_fee: "brix protocol fee",
  reg_pre_investor_yield: "investor yield",
  reg_months_help: "between 3 and 12 months · rate scales lightly with term.",
  reg_apr_l: "annual rate charged to the owner",
  reg_apr_help: ((min: number, max: number) =>
    `between ${min}% and ${max}% · brix takes 2% as spread, the rest goes to investors`) as unknown as string,
  reg_apr_oor: ((min: number, max: number) =>
    `rate outside allowed range (${min}% – ${max}%)`) as unknown as string,
